...
public class LARERules extends Browser {
	...
	public void LAREAlwaysUseProfileTest () throws InterruptedException {
	    ...
	    Assert.assertEquals(driver.findElement(By.cssSelector("span.store-details-store-name.flyover-src")).getText(),"Fairfax, VA","The site session wasn't correctly displayed");
	}
