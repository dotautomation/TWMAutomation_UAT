...
//		public static final By YourStore = By.cssSelector(".header-chg-loc.nav-li.toggle-cont>a");
//		public static final By ChangeLocation = By.cssSelector("tr:nth-child(1) > td:nth-child(2) > a");
		public static final By ChangeLocation = By.cssSelector(".header-chg-loc.nav-li.toggle-cont>a");
		public static final By FindStoreTab = By.cssSelector("#changeLocation > div > div > div > div > div > div.store-filter-wrapper > ul > li:nth-child(1) > a");
