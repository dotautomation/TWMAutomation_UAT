...
public class NewUserRegistrationCustomAC extends Browser {

	@DataProvider(name="CheckoutParameters")
    public Object[][] createData() {
    	Object[][] retObjArr=ConfigurationFunctions.getTableArray(ConfigurationFunctions.resourcePath,"Checkout", "RegistrationCustomAC");
        return(retObjArr);
    } 
	...
	public void NewUserRegistrationCustomAcTest (String Location,String StoreName,String PDP,String Quantity,String ShipOption,String FirstName,
