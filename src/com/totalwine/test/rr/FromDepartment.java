...
public class FromDepartment extends Browser{
	...
	public void FromDepartmentRR () throws InterruptedException {
		...
		sAssert.assertEquals(driver.findElement(By.cssSelector("div.breadcrumbs > ul > li > a.last")).getText(), "Wine");//Breadcrumbs says Wine
		...
		sAssert.assertEquals(driver.findElement(By.cssSelector("div.breadcrumbs > ul > li > a.last")).getText(), "Spirits");//Breadcrumbs says Spirits
		...
		sAssert.assertEquals(driver.findElement(By.cssSelector("div.breadcrumbs > ul > li > a.last")).getText(), "Beer");//Breadcrumbs says Spirits
		...
		sAssert.assertEquals(driver.findElement(By.cssSelector("div.breadcrumbs > ul > li > a.last")).getText(), "Accessories & More");//Breadcrumbs says Accessories & More
